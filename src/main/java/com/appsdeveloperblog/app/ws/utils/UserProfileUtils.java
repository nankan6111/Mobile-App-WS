...
import com.appsdeveloperblog.app.ws.exception.MissingRequiredFieldException;
...
public class UserProfileUtils {
	...
	public byte[] encrypt(String securedPassword, String accessTokenMaterial) throws InvalidKeySpecException {
		return hash(securedPassword.toCharArray(), accessTokenMaterial.getBytes());
	}
